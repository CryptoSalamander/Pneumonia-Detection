...
mypd = pd.DataFrame(history, index=epochs)
mypd.to_csv('result.csv')
...
"""
model_path = './Resnet50_512/mask_rcnn_pneumonia_0018.h5'
...
submission_fp = os.path.join(ROOT_DIR, 'submission_fine.csv')
